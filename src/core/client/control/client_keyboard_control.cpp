...
namespace cvulkan::client::control {
    void KeyboardControl::glfwCallbacks() {
        glfwSetWindowUserPointer(m_window.glfwWindowDescriptor(), this);
        glfwSetKeyCallback(this->m_window.glfwWindowDescriptor(), [](GLFWwindow* window, const int key, int scancode, const int action, int mods) {
